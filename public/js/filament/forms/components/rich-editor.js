var po = "2.1.12", wt = "[data-trix-attachment]",
    mi = {preview: {presentation: "gallery", caption: {name: !0, size: !0}}, file: {caption: {size: !0}}}, W = {
    ...
    }, fi = i => document.activeElement !== i && Tt(i, document.activeElement), Tt = function (i, t) {
        if (i && t) for (; t;) {
            if (t === i) return !0;
            t = t.parentNode
        }
        ...
        return ie
    }, Rn = i => qt(i?.firstChild), Yi = function (i) {
        let {strict: t} = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {strict: !0};
        return t ? qt(i) : qt(i) || !qt(i.firstChild) && function (e) {
            return de().includes(j(e)) && !de().includes(j(e.firstChild))
        }(i)
    }, qt = i => vo(i) && i?.data === "block", vo = i => i?.nodeType === Node.COMMENT_NODE, Ht = function (i) {
        let {name: t} = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        if (i) return ge(i) ? i.data === ln ? !t || i.parentNode.dataset.trixCursorTarget === t : void 0 : Ht(i.firstChild)
    }, Lt = i => Ir(i, wt), Or = i => ge(i) && i?.data === "", ge = i => i?.nodeType === Node.TEXT_NODE, bi = {
...
var So = 0, dt = class extends R {
    ...
    To = () => (Nn || (Nn = Object.keys(W)), Nn), ti = i => It[i], wo = () => (In || (In = Object.keys(It)), In),
    Pr = function (i, t) {
    ...
    ue = i => i.replace(new RegExp("".concat(ln), "g"), "").replace(new RegExp("".concat(bt), "g"), " "),
    ...
    }, ir = i => i.dataset.trixStoreKey, Jt = class extends R {
        isPerforming() {
...
} = Object, {freeze: V, seal: Y, create: Vr} = Object, {apply: oi, construct: si} = typeof Reflect < "u" && Reflect;
V || (V = function (i) {
    return i
}), Y || (Y = function (i) {
    return i
...
var Ne = G(Array.prototype.forEach), or = G(Array.prototype.pop), oe = G(Array.prototype.push),
    _e = G(String.prototype.toLowerCase), Fn = G(String.prototype.toString), sr = G(String.prototype.match),
    se = G(String.prototype.replace), _o = G(String.prototype.indexOf), jo = G(String.prototype.trim),
    X = G(Object.prototype.hasOwnProperty), _ = G(RegExp.prototype.test), ae = (ar = TypeError, function () {
...
function Rt(i) {
    let t = Vr(null);
    for (let [e, n] of Ur(i)) X(i, e) && (Array.isArray(n) ? t[e] = Wo(n) : n && typeof n == "object" && n.constructor === Object ? t[e] = Rt(n) : t[e] = n);
    return t
}
...
var lr = V(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
    Pn = V(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "circle", "clippath", "defs", "desc", "ellipse", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "view", "vkern"]),
    Mn = V(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]),
    Uo = V(["animate", "color-profile", "cursor", "discard", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "foreignobject", "hatch", "hatchpath", "mesh", "meshgradient", "meshpatch", "meshrow", "missing-glyph", "script", "set", "solidcolor", "unknown", "use"]),
    Bn = V(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover", "mprescripts"]),
    Vo = V(["maction", "maligngroup", "malignmark", "mlongdiv", "mscarries", "mscarry", "msgroup", "mstack", "msline", "msrow", "semantics", "annotation", "annotation-xml", "mprescripts", "none"]),
    cr = V(["#text"]),
    ur = V(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "controlslist", "coords", "crossorigin", "datetime", "decoding", "default", "dir", "disabled", "disablepictureinpicture", "disableremoteplayback", "download", "draggable", "enctype", "enterkeyhint", "face", "for", "headers", "height", "hidden", "high", "href", "hreflang", "id", "inputmode", "integrity", "ismap", "kind", "label", "lang", "list", "loading", "loop", "low", "max", "maxlength", "media", "method", "min", "minlength", "multiple", "muted", "name", "nonce", "noshade", "novalidate", "nowrap", "open", "optimum", "pattern", "placeholder", "playsinline", "popover", "popovertarget", "popovertargetaction", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "wrap", "xmlns", "slot"]),
    _n = V(["accent-height", "accumulate", "additive", "alignment-baseline", "amplitude", "ascent", "attributename", "attributetype", "azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clippathunits", "clip-path", "clip-rule", "color", "color-interpolation", "color-interpolation-filters", "color-profile", "color-rendering", "cx", "cy", "d", "dx", "dy", "diffuseconstant", "direction", "display", "divisor", "dur", "edgemode", "elevation", "end", "exponent", "fill", "fill-opacity", "fill-rule", "filter", "filterunits", "flood-color", "flood-opacity", "font-family", "font-size", "font-size-adjust", "font-stretch", "font-style", "font-variant", "font-weight", "fx", "fy", "g1", "g2", "glyph-name", "glyphref", "gradientunits", "gradienttransform", "height", "href", "id", "image-rendering", "in", "in2", "intercept", "k", "k1", "k2", "k3", "k4", "kerning", "keypoints", "keysplines", "keytimes", "lang", "lengthadjust", "letter-spacing", "kernelmatrix", "kernelunitlength", "lighting-color", "local", "marker-end", "marker-mid", "marker-start", "markerheight", "markerunits", "markerwidth", "maskcontentunits", "maskunits", "max", "mask", "media", "method", "mode", "min", "name", "numoctaves", "offset", "operator", "opacity", "order", "orient", "orientation", "origin", "overflow", "paint-order", "path", "pathlength", "patterncontentunits", "patterntransform", "patternunits", "points", "preservealpha", "preserveaspectratio", "primitiveunits", "r", "rx", "ry", "radius", "refx", "refy", "repeatcount", "repeatdur", "restart", "result", "rotate", "scale", "seed", "shape-rendering", "slope", "specularconstant", "specularexponent", "spreadmethod", "startoffset", "stddeviation", "stitchtiles", "stop-color", "stop-opacity", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke", "stroke-width", "style", "surfacescale", "systemlanguage", "tabindex", "tablevalues", "targetx", "targety", "transform", "transform-origin", "text-anchor", "text-decoration", "text-rendering", "textlength", "type", "u1", "u2", "unicode", "values", "viewbox", "visibility", "version", "vert-adv-y", "vert-origin-x", "vert-origin-y", "width", "word-spacing", "wrap", "writing-mode", "xchannelselector", "ychannelselector", "x", "x1", "x2", "xmlns", "y", "y1", "y2", "z", "zoomandpan"]),
    hr = V(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]),
    Ie = V(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]), zo = Y(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
    qo = Y(/<%[\w\W]*|[\w\W]*%>/gm), Ho = Y(/\$\{[\w\W]*}/gm), Jo = Y(/^data-[\-\w.\u00B7-\uFFFF]+$/),
    Ko = Y(/^aria-[\-\w]+$/),
    zr = Y(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
    Go = Y(/^(?:\w+script|data):/i), $o = Y(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
    qr = Y(/^html$/i), Yo = Y(/^[a-z][.\w]*(-[.\w]+)+$/i), dr = Object.freeze({
        __proto__: null,
        ARIA_ATTR: Ko,
        ATTR_WHITESPACE: $o,
        CUSTOM_ELEMENT: Yo,
        ...
        let {document: n} = t, r = n, o = r.currentScript, {
                ...
                DOMParser: H,
                trustedTypes: tt
            } = t, M = u.prototype, pt = le(M, "cloneNode"), Ct = le(M, "remove"), Zt = le(M, "nextSibling"),
        ...
        e.isSupported = typeof Ur == "function" && typeof F == "function" && Et && Et.createHTMLDocument !== void 0;
        let {
                MUSTACHE_EXPR: un,
                ERB_EXPR: hn,
                TMPLIT_EXPR: dn,
            ...
            })), te = null, gn = null, Ti = !0, mn = !0, wi = !1, Li = !0, Bt = !1, pn = !0, St = !1, fn = !1, bn = !1, _t = !1,
            Ee = !1, Se = !1, Di = !0, Ni = !1, vn = !0, ee = !1, jt = {}, Wt = null,
            ...
            I = null, Vt = null, go = n.createElement("form"), Mi = function (a) {
            ...
            }, Bi = b({}, [...Pn, ...Mn, ...Uo]), _i = b({}, [...Bn, ...Vo]), et = function (a) {
                ...
                return a && h && A.insertBefore(n.createTextNode(h), A.childNodes[0] || null), Ut === st ? io.call(g, St ? "html" : "body")[0] : St ? g.documentElement : A
            }, Wi = function (a) {
        ...
        let Vi = function (a) {
            ...
            if (at(J.uponSanitizeElement, a, {
                tagName: h,
                allowedTags: N
            }), a.hasChildNodes() && !Ui(a.firstElementChild) && _(/<[/\w]/g, a.innerHTML) && _(/<[/\w]/g, a.textContent) || a.nodeType === Qo || pn && a.nodeType === ts && _(/<[/\w]/g, a.data)) return et(a), !0;
            if (!N[h] || te[h]) {
                if (!te[h] && qi(h) && (w.tagNameCheck instanceof RegExp && _(w.tagNameCheck, h) || w.tagNameCheck instanceof Function && w.tagNameCheck(h))) return !1;
                if (vn && !Wt[h]) {
            ...
            return a instanceof u && !function (v) {
                ...
                return !!xn[v.namespaceURI] && (v.namespaceURI === Re ? A.namespaceURI === st ? f === "svg" : A.namespaceURI === ke ? f === "svg" && (D === "annotation-xml" || Te[D]) : !!Bi[f] : v.namespaceURI === ke ? A.namespaceURI === st ? f === "math" : A.namespaceURI === Re ? f === "math" && we[D] : !!_i[f] : v.namespaceURI === st ? !(A.namespaceURI === Re && !we[D]) && !(A.namespaceURI === ke && !Te[D]) && !_i[f] && (uo[f] || !Bi[f]) : !(ne !== "application/xhtml+xml" || !xn[v.namespaceURI]))
            }(a) ? (et(a), !0) : h !== "noscript" && h !== "noembed" && h !== "noframes" || !_(/<\/no(script|embed|frames)/i, a.innerHTML) ? (Bt && a.nodeType === Zo && (g = a.textContent, Ne([un, hn, dn], v => {
                g = se(g, v, " ")
            ...
            if (!(mn && !gn[g] && _(oo, g))) {
                if (!(Ti && _(so, g))) {
                    if (!O[g] || gn[g]) {
                        if (!(qi(a) && (w.tagNameCheck instanceof RegExp && _(w.tagNameCheck, a) || w.tagNameCheck instanceof Function && w.tagNameCheck(a)) && (w.attributeNameCheck instanceof RegExp && _(w.attributeNameCheck, g) || w.attributeNameCheck instanceof Function && w.attributeNameCheck(g)) || g === "is" && w.allowCustomizedBuiltInElements && (w.tagNameCheck instanceof RegExp && _(w.tagNameCheck, h) || w.tagNameCheck instanceof Function && w.tagNameCheck(h)))) return !1
                    } else if (!An[g]) {
                        if (!_(Si, se(h, Ei, ""))) {
            ...
            for (; v--;) {
                let A = g[v], {name: f, namespaceURI: D, value: lt} = A, nt = I(f), B = f === "value" ? lt : jo(lt);
                if (h.attrName = nt, h.attrValue = B, h.keepAttr = !0, h.forceKeepAttr = void 0, at(J.uponSanitizeAttribute, a, h), B = h.attrValue, !Ni || nt !== "id" && nt !== "name" || (Le(f, a), B = "user-content-" + B), pn && _(/((--!?|])>)|<\/(style|title)/i, B)) {
                    Le(f, a);
                    continue
                }
                ...
                let Ji = I(a.nodeName);
                if (zi(Ji, nt, B)) {
                    if (k && typeof tt == "object" && typeof tt.getAttributeType == "function" && !D) switch (tt.getAttributeType(Ji, nt)) {
                        case"TrustedHTML":
                            B = k.createHTML(B);
                            break;
                    ...
                    try {
                        D ? a.setAttributeNS(D, f, B) : a.setAttribute(f, B), En(a) ? et(a) : or(e.removed)
                    } catch {
                    }
                }
            }
            ...
            let h = null, v = Wi(g);
            for (at(J.beforeSanitizeShadowDOM, g, null); h = v.nextNode();) at(J.uponSanitizeShadowNode, h, null), Vi(h), Hi(h), h.content instanceof s && a(h.content);
        ...
        return e.sanitize = function (a) {
            ...
            let D = Wi(ee ? a : h);
            for (; A = D.nextNode();) Vi(A), Hi(A), A.content instanceof s && mo(A.content);
            if (ee) return a;
            if (_t) {
            ...
            return St && N["!doctype"] && h.ownerDocument && h.ownerDocument.doctype && h.ownerDocument.doctype.name && _(qr, h.ownerDocument.doctype.name) && (lt = "<!DOCTYPE " + h.ownerDocument.doctype.name + `>
` + lt), Bt && Ne([un, hn, dn], nt => {
                lt = se(lt, nt, " ")
...
var is = "style href src width height language class".split(" "), rs = "javascript:".split(" "),
    os = "script iframe form noscript".split(" "), Kt = class extends R {
        constructor(t) {
            let {
                allowedAttributes: e,
...
`);
        ...
        createNodes() {
            ...
            for (let o = 0; o < e.length; o++) {
                ...
                let c = this.findOrCreateCachedChildView(qe, s, {textConfig: this.textConfig, context: l});
    ...
    }, ls = i => /\s$/.test(i?.toString()), {css: mr} = Ce, Je = class extends gt {
        constructor() {
...
q(xt, "permittedAttributes", ["caption", "presentation"]), mt.registerType("attachment", xt);
...
var $t = class extends dt {
        ...
        return e
    }, ps = i => i[0], fs = i => i[1], K = class extends dt {
        constructor() {
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
            super(...arguments);
        ...
        constructor(t, e, n) {
            super(...arguments), this.text = bs(t || new K), this.attributes = e || [], this.htmlAttributes = n || {}
        }
...
`)}if(r!==-1)return r}contentsForInspection(){return{text:this.text.inspect(),attributes:this.attributes}}toString(){return this.text.toString()}toJSON(){return{text:this.text,attributes:this.attributes,htmlAttributes:this.htmlAttributes}}getDirection(){return this.text.getDirection()}isRTL(){return this.text.isRTL()}getLength(){return this.text.getLength()}canBeConsolidatedWith(t){return!this.hasAttributes()&&!t.hasAttributes()&&this.getDirection()===t.getDirection()}consolidateWith(t){let e=K.textForStringWithAttributes(`
`), n = this.getTextWithoutBlockBreak().appendText(e);
        ...
        return r ? (n = n.map(o => o.isBlockBreak() ? (t = !0, xs(o)) : o), t ? new K([...n, r]) : i) : i
...
`, {blockBreak: !0}), ys = function (i) {
        ...
        constructor() {
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
            super(...arguments), t.length === 0 && (t = [new $]), this.blockList = $t.box(t)
        }
...
`) e = this.blockList.editObjectAtIndex(d, H => H.copyWithText(H.text.removeTextAtRange([C, C + 1]))); else {
                let H, tt = u.text.getTextAtRange([0, c]), M = T.text.getTextAtRange([C, T.getLength()]),
                    pt = tt.appendText(M);
                H = l !== d && c === 0 && u.getAttributeLevel() >= T.getAttributeLevel() ? T.copyWithText(pt) : u.copyWithText(pt);
                let Ct = d + 1 - l;
        ...
        insertBlockBreakAtRange(t) {
            ...
            return r === 0 && (e = [new $]), new this.constructor(o.blockList.insertSplittableListAtPosition(new $t(e), n))
        }
...
`)
    ...
    insertBlock() {
        let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : new $, e = new z([t]);
...
`?t.previousCharacter===`
`?o=[r-1,r+1]:(o=[r,r+1],r+=1):t.startLocation.offset-1!=0&&(r+=1);let s=new z([n.removeLastAttribute().copyWithoutText()]);return this.setDocument(e.insertDocumentAtRange(s,o)),this.setSelection(r)}getPreviousBlock(){let t=this.getLocationRange();if(t){let{index:e}=t[0];if(e>0)return this.document.getBlockAtIndex(e-1)}}getBlock(){let t=this.getLocationRange();if(t)return this.document.getBlockAtIndex(t[0].index)}getAttachmentAtRange(t){let e=this.document.getDocumentAtRange(t);if(e.toString()==="".concat("\uFFFC",`
...
` && (this.document = this.document.insertBlockBreakAtRange(e[0]), e[0] < this.selectedRange[0] && this.moveSelectedRangeForward(), e[0]++, t++), this.document = this.document.applyBlockAttributeAtRange(Wn, !0, e))
        ...
        findContainerAndOffsetFromLocation(t) {
            ...
            if (r) {
                if (ge(r)) Un(r) === 0 ? (e = r.parentNode.parentNode, n = kn(r.parentNode), Ht(r, {name: "right"}) && n++) : (e = r, n = t.offset - o); else {
        ...
        return i.nodeType === Node.TEXT_NODE ? Ht(i) ? 0 : i.textContent.length : j(i) === "br" || Lt(i) ? 1 : 0
    }, Os = function (i) {
...
var Xr = Object.freeze({
        ...
        TextView: He
    }), {lang: Vn, css: kt, keyNames: Ms} = Ce, zn = function (i) {
        return function () {
        ...
        constructor(t, e, n) {
            ...
            super(...arguments), q(this, "makeElementMutable", zn(() => ({
                do: () => {
                    this.element.dataset.trixMutable = !0
                }, undo: () => delete this.element.dataset.trixMutable
            }))), q(this, "addToolbar", zn(() => {
                let o = p({
                    tagName: "div",
            ...
            })), q(this, "installCaptionEditor", zn(() => {
                let o = p({
                    tagName: "textarea",
                ...
                return {
                    do: () => {
                        if (c.style.display = "none", u.appendChild(o), u.appendChild(s), u.classList.add("".concat(kt.attachmentCaption, "--editing")), c.parentElement.insertBefore(u, c), l(), this.options.editCaption) return Ai(() => o.focus())
                    }, undo() {
    ...
    rn = class extends R {
        ...
        getTextChangesFromChildList() {
            ...
            }), n.length === 0 && r.length === 1 && qt(r[0]) ? (t = [], e = [`
`]) : (t = li(n), e = li(r));
        ...
        getTextChangesFromCharacterData() {
            ...
            if (n.length) {
                let r = n[0], o = n[n.length - 1], s = function (l, c) {
                    let u, d;
                    return l = Ot.box(l), (c = Ot.box(c)).length < l.length ? [d, u] = nr(l, c) : [u, d] = nr(c, l), {
                        added: u,
                        removed: d
                    }
...
`) : t.push(...Array.from(li(e.childNodes) || []))
    ...
    }, js = (i, t) => Sr(i) === Sr(t), Ws = new RegExp("(".concat("\uFFFC", "|").concat(ln, "|").concat(bt, "|\\s)+"), "g"),
...
q(Yt, "events", {});
var {browser: Us, keyNames: Qr} = Ce, Vs = 0, Z = class extends Yt {
    constructor() {
...
q(Z, "events", {
    keydown(i) {
        ...
        if (n) {
            ...
            var T, H, tt;
            e.type = "text/html", e.html = r, (T = this.delegate) === null || T === void 0 || T.inputControllerWillPaste(e), (H = this.responder) === null || H === void 0 || H.insertHTML(e.html), this.requestRender(), (tt = this.delegate) === null || tt === void 0 || tt.inputControllerDidPaste(e)
            ...
            if (F) {
                var Ct, Zt, Qt;
                let k = zs(F);
                !F.name && k && (F.name = "pasted-file-".concat(++Vs, ".").concat(k)), e.type = "File", e.file = F, (Ct = this.delegate) === null || Ct === void 0 || Ct.inputControllerWillAttachFiles(), (Zt = this.responder) === null || Zt === void 0 || Zt.insertFile(e.file), this.requestRender(), (Qt = this.delegate) === null || Qt === void 0 || Qt.inputControllerDidPaste(e)
            }
        }
        i.preventDefault()
    }, compositionstart(i) {
...
}), Z.proxyMethod("responder?.getSelectedRange"), Z.proxyMethod("responder?.setSelectedRange"), Z.proxyMethod("responder?.expandSelectionInDirection"), Z.proxyMethod("responder?.selectionIsInCursorTarget"), Z.proxyMethod("responder?.selectionIsExpanded");
var zs = i => {
    var t;
    return (t = i.type) === null || t === void 0 || (t = t.match(/\/(\w+)$/)) === null || t === void 0 ? void 0 : t[1]
}, qs = !((qn = " ".codePointAt) === null || qn === void 0 || !qn.call(" ", 0)), Hs = function (i) {
    if (i.key && qs && i.key.codePointAt(0) === i.keyCode) return i.key;
    {
        let t;
        if (i.which === null ? t = i.keyCode : i.which !== 0 && i.charCode !== 0 && (t = i.charCode), t != null && Qr[t] !== "escape") return Ot.fromCodepoints([t]).toString()
    }
}, Js = function (i) {
...
var Ks = function (i) {
    ...
    Rr = (i, t) => (t || (t = zt(i)), i.querySelector("[data-trix-input][name='".concat(t, "']"))),
    ...
    sn = class extends R {
        ...
        eachAttributeButton(t) {
            return Array.from(this.element.querySelectorAll(ui)).map(e => t(e, zt(e)))
        }
...
var ct = new WeakMap, ce = new WeakSet, di = class {
    constructor(t) {
        var e, n;
        Jr(e = this, n = ce), n.add(e), pe(this, ct, {
            writable: !0,
            value: void 0
        }), this.element = t, Ci(this, ct, t.attachInternals())
    }
...
Object.assign(Q, Xr), window.Trix = Q, setTimeout(function () {
...
Q.config.blockAttributes.heading = {tagName: "h2", terminal: !0, breakOnReturn: !0, group: !1};
Q.config.blockAttributes.subHeading = {tagName: "h3", terminal: !0, breakOnReturn: !0, group: !1};
