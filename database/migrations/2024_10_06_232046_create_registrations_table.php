...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('registrations', function (Blueprint $table) {
            ...
            $table->enum('registration_status', ['registered', 'in_progress', 'completed', 'withdrawn'])->default('in_progress')->index();
            $table->enum('proctor_approval_status', ['pending', 'approved', 'rejected'])->default('pending')->index();
